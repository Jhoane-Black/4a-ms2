        ...
        <div class="panels-container">
            ...
            <div class="panel left-panel">
                ...
                <div class="content">
                    ...
                    <p>No dudes en crear una cuenta con nosotros, podemos ayudarte si deseas comprar o vender productos únicos de nuestra tierra.</p>
                    <button v-on:click="loadSignUp" class="btn transparent" id="sign-up-btn">
                        Registrarse
                    </button>
